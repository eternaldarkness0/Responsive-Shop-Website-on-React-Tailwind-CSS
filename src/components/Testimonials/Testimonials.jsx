...
return (
    <section id='testimonials' className='py-10 mb-10'>
        <div className='container'>
            {/* text section */}
            <div className='text-center mb-10 max-w-[600px] mx-auto'>
                <p
                data-aos='fade-left'
                className='text-lg text-primary'>What our customers are saying about us</p>
                <h1
                data-aos='fade-right'
            ...
            <div className='my-6' key={data.id}>
                ...
                bg-primary/10 relative'>
                    ...
                    <p
                    className='absolute text-black/20 text-9xl font-serif top-0 right-0'
                    >,,</p>
                </div>
            </div>
            ))}
